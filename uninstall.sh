...
rm -f /usr/local/share/applications/mcp2210-com.desktop
rmdir --ignore-fail-on-non-empty /usr/local/share/applications
rm -f /usr/local/share/icons/hicolor/128x128/apps/mcp2210-com.png
...
rm -f /usr/local/bin/mcp2210-com
echo Removing source code files...
rm -rf /usr/local/src/mcp2210-com
echo Done!
